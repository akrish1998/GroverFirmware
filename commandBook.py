...
class COMMAND_BOOK():
    def __init__(self):
        ...
        self.book["raf"] = functionalityTests.roll_all_forward                  # 1 - 3 args
        self.book["rab"] = functionalityTests.roll_all_backward                 # 1 - 3 args
        self.book["aar"] = functionalityTests.articulate_all_corners_right      # 1 - 3 args
        self.book["aal"] = functionalityTests.articulate_all_corners_left       # 1 - 3 args
        self.book["rs"] = functionalityTests.rotate_set                         # 3 - 5 args
        self.book["ri"] = functionalityTests.rotate_individual_wheel            # 4 - 6 args
        self.book["k"] = functionalityTests.kill_all                            # 1 args
        self.book["kill"] = functionalityTests.kill_all                         # 1 args
      
      
    # dumps this info when user enters help cuz I'm dumb and can't remember every command and its fields
